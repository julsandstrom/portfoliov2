...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 sm:mt-14 md:mt-20 flex gap-4 sm:gap-10 scroll-smooth snap-x snap-mandatory overflow-x-auto scrollbar-none">
        {projects.map((p) => {
            ...
            >
              ...
              <div className="flex items-center justify-between px-2 py-3 md:py-5">
                <a
                  ...
                  className="text-2xl sm:text-3xl  font-light text-[#F5672D] flex cursor-pointer hover:text-[#ECA85A]"
                >
                  {p.title}
                  <img
