    ...
    <section className="mx-auto max-w-5xl sm:max-6xl md:max-w-6xl   px-5  min-h-[80vh] xl:min-h-screen flex flex-col items-center justify-center gap-3">
      <div className="relative inline-block">
        <img
          ...
          loading="eager"
        />
        <p className="font-grotesk text-sm sm:text-xl md:text-2xl font-extralight opacity-60 uppercase tracking-[0.4em] text-[#ECECEC] mt-1 sm:mt-6 md:mt-8 text-right">
          Developer
        </p>
        <img
          src="/images/PixelJulle.png"
          alt="Avatar Image"
          className="w-20 z-10 absolute left-10 sm:w-40 sm:left-16 top-[-9px] sm:top-[-15px] md:w-52 lg:w-[290px] md:left-28 md:-top-5 lg:-top-8"
        />
      </div>
